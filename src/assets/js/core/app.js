...
$(function() {
    ...
    $("#footerYear").text(moment().year());
    
    // Update the footer year
    $("#footerAppVersion").text("0.0.2-alpha.18");
    ...
    $('.heading-elements-toggle').unbind('click');                
    ...
    $('.navbar-nav .disabled a').on('click', function() {
    ...
    // -------------------------
    // Main navigation
    $('.navigation-main > li > ul > a').unbind('click');    
    ...
    $('.navigation-alt > li > ul > a').unbind('click');        
    ...
    // -------------------------
    // Toggle mini sidebar
    $('.sidebar-main-toggle').unbind('click');    
    ...
    $('.sidebar-mobile-secondary-toggle').unbind('click');    
